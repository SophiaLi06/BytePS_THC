...
parser.add_argument('--net', default='ResNet50', choices=['ResNet50', 'ResNet101', 'ResNet152'],
...
if args.save_lr_accu:
    ...
    with open('../example/pytorch/accuracy_and_lr_record/imagenet/'+compressor_name+'_'+args.net+'-'+curr_time+'.pkl', 'wb') as pkl_file:
